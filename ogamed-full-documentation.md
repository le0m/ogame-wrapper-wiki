...
[`GET  /bot/server-url`](#server-url)  
[`POST /bot/page-content`](#page-content)  
[`GET  /bot/login`](#login)  
...
[`POST /bot/fleets/:fleetID/cancel`](#send-a-fleet)  
GET  /bot/attacks  
...
[`GET  /bot/planets/:planetID/resource-settings`](#get-planet-resources-buildings)  
[`POST /bot/planets/:planetID/resource-settings`](#get-planet-resources)  
